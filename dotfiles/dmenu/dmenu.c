...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeOut, SchemeSelHighlight, SchemeNormHighlight, SchemeOutHighlight, SchemeHp, SchemeLast }; /* color schemes */
/* enum { SchemeNorm, SchemeSel, SchemeNormHighlight, SchemeSelHighlight, */
       /* SchemeOut, SchemeLast }; /1* color schemes *1/ */
